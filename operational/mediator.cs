...
namespace MediatorPattern
{
    ...
    // Concrete Mediator
    class IstanbulControl:IAirportControl
    {
    ...
    class Program
    {
          // Kule nesnesi örneklenir(Concrete Mediator)
            ...
            ZorluYol zy99 = new ZorluYol { Airport = istanbulKule, FlightNumber = "zy99", From = "Antartika" };
